...
grant_statement = perm.state_desc + ' ' + perm.permission_name + ' ON ' + quotename(object_schema_name(perm.major_id)) + '.' + quotename(object_name(perm.major_id)) + ' TO ' + roleprinc.name COLLATE DATABASE_DEFAULT,
revoke_statement = 'REVOKE ' + perm.permission_name + ' ON ' + quotename(object_schema_name(perm.major_id)) + '.' + quotename(object_name(perm.major_id)) + ' TO ' + roleprinc.name COLLATE DATABASE_DEFAULT
